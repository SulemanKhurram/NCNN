...
def save_class_activation_images(plots_path, org_img, activation_map, file_name):
    """
    ...
    path_to_file = plots_path + file_name+'_Cam_Heatmap.png'
    print(np.max(heatmap))
    save_image(heatmap, path_to_file)
    # Save heatmap on iamge
    print()
    print(np.max(heatmap_on_image))
    path_to_file = plots_path+ file_name+'_Cam_On_Image.png'
    save_image(heatmap_on_image, path_to_file)
    # SAve grayscale heatmap
    print()
    print(np.max(activation_map))
    path_to_file = plots_path+ file_name+'_Cam_Grayscale.png'
