...
from grad_cam_bayes import GradCam
from bcnn_layer_visualization import BCNNLayerVisualization

parser = argparse.ArgumentParser(description='Bayesian Model Visualizations CAM and features')
parser.add_argument('--dataset', default='g1020', type=str, help='dataset = [g1020/isic]')
args = parser.parse_args()
base_path = validate_dir(cf.viz_bayes_base_folder+'/')
